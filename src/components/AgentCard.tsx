...
import { ArrowRight, Sparkles, DollarSign, Clock, MessageSquare } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="flex gap-2">
          <Button 
            className="flex-1 group-hover:bg-magic group-hover:text-magic-foreground transition-colors" 
            variant="glass"
